        ...
        <el-main>
          <div v-for="(item, index) in this.course":key="item.courseName" class="courseDiv">
            ...
            <div class="courseDivP2">
              ...
              <el-divider class="myDivider"></el-divider>
              <div style="display: flex; flex-direction: row-reverse"><el-button @click="deleteCourse(index)" size="small">删除</el-button></div>
            </div>
    ...
    <el-dialog
      ...
      <el-form ref="newCourseForm" :model="newCourseForm" label-width="80px">
        <el-form-item label="加课码">
          <el-input v-model="newCourseForm.courseId"></el-input>
        </el-form-item>
        <el-form-item label="课程名">
          <el-input v-model="newCourseForm.courseName"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    findAllCourse(){
      this.$axios.get("/Teacher/getCourse?uid="+this.uid).then((resp)=>{
    ...
    addCourse(){
      this.newCourseForm.courseTeacher=this.uid;
      this.$axios.post("/Teacher/addCourse", this.newCourseForm).then((resp)=>{
    ...
    deleteCourse(index){
      this.$confirm('此操作将永久删除课程, 是否继续?', '提示', {
        ...
        this.$axios.get("/Teacher/deleteCourse?courseId="+this.course[index].courseId).then((resp)=>{
